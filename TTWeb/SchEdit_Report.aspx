<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchEdit_Report.aspx.cs" Inherits="TTWeb.SchEdit_Report" uiCulture="en" Culture="en-US" %>
...
<dx:PanelContent runat="server" SupportsDisabledAttribute="True">
    <table class="style1">
        <tr>
            <td>
                <dx:ReportToolbar ID="SchEdit_ReportToolbar" runat="server" 
                    ClientIDMode="AutoID" ReportViewer="<%# SchEdit_ReportViewer %>" 
                ...
                <dx:ReportViewer ID="SchEdit_ReportViewer" runat="server" ClientIDMode="AutoID" 
