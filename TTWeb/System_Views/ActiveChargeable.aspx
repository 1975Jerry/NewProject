<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActiveChargeable.aspx.cs" Inherits="TTWeb.ActiveChargeable" %>
...
<body style="font-size: 8pt">
    ...
    function OnGetSelectedFieldValues(selectedValues) {
        for (var i = 0; i < 36; i++) {
            var editor = ASPxGridViewActiveChargeable.GetEditor(i + 1);
            if (editor != null) {
    ...
    <div>
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" ClientIDMode="AutoID" 
            ...
            GroupBoxCaptionOffsetY="-19px" HeaderText="Active Chargeable" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">Active Chargeable Tickets
                        </td>
...
<table cellpadding="0" cellspacing="0" class="style1">
	...
	{
        popupsri1.Show();
        CallbackSRI.PerformCallback(ASPxGridViewActiveChargeable.GetRowKey(ASPxGridViewActiveChargeable.GetFocusedRowIndex()));
    }
    ...
    ClientInstanceName="ASPxGridViewActiveChargeable" 
    CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
    KeyFieldName="CH_ID" AutoGenerateColumns="False" Width="100%" 
    ClientIDMode="AutoID" ID="ASPxGridViewActiveChargeable" 
    EnableViewState="False" 
        Theme="Metropolis" style="font-size: 8pt" 
        OnHtmlRowPrepared="ASPxGridViewActiveChargeable_HtmlRowPrepared" 
        OnRowInserting="ASPxGridViewActiveChargeable_RowInserting" 
        OnRowDeleting="ASPxGridViewActiveChargeable_RowDeleting" 
        OnRowUpdating="ASPxGridViewActiveChargeable_RowUpdating" 
        OnLoad="ASPxGridViewActiveChargeable_Load" 
        OnStartRowEditing="ASPxGridViewActiveChargeable_StartRowEditing" 
        OnHtmlRowCreated="ASPxGridViewActiveChargeable_HtmlRowCreated">
    ...
    combosite.PerformCallback(projectcombo.GetText());
                                ...
                                <tr>
                                    ...
                                    <td class="style12" style="padding-right: 2px; " valign="middle">
                                        PO:</td>
                                    <td class="style13">
                                        <dx:ASPxTextBox ID="ASPxTextBoxPO" runat="server" EnableTheming="True" 
                                            Font-Size="8pt" Text='<%# Bind("PO") %>' Theme="Aqua" Width="200px">
                                        </dx:ASPxTextBox>
                                    </td>
                                    <td class="style12" style="padding-right: 2px; background-color: #FFFBFF;" 
                                        valign="middle">
                                ...
                                <tr>
                                    ...
                                    <td class="style12" style="padding-right: 2px; background-color: #FFFBFF;" 
                                        valign="middle">
                                        <span class="style15">** </span>Approval date:</td>
                                    <td class="style13" 
                                        style="border-right-style: solid; border-width: 1px; border-color: #000066; background-color: #FFFBFF;">
                                ...
                                <tr>
                                    ...
                                    <td style="border-right-style: solid; border-width: 1px; border-color: #000066" 
                                        valign="top">
                                        <span class="style15">** </span><span class="style16">Approval date is mandatory 
                                        when marked as To be Scheduled</span></td>
                                </tr>
                            </table>
                        </EditForm>
                        <DetailRow>
...
if (e.result.split(';')[2] == &quot;no&quot;)
{
        ...
        ASPxGridViewActiveChargeable.Refresh();
} 
else
{
		popupsri1.Hide();
    ...
    <dx:ASPxGridViewExporter ID="ASPxGridViewExporter2" runat="server" 
        GridViewID="ASPxGridViewActiveChargeable" Landscape="True" PaperKind="A4">
        <Styles>
            <Default Font-Size="8pt">
            </Default>
        </Styles>
        <PageHeader Left="Active Chargeable Tickets" 
            Right="[Page # of Pages #]">
        </PageHeader>
