<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExpertTickets.aspx.cs" Inherits="TTWeb.ExpertTickets" %>
...
<body style="font-size: 8pt">
    ...
    function OnGetSelectedFieldValues(selectedValues) {
        for (var i = 0; i < 36; i++) {
            var editor = ASPxGridViewExpertTickets.GetEditor(i + 1);
            if (editor != null) {
        ...
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" ClientIDMode="AutoID" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">Expert Trouble Tickets Pre-processing
                        </td>
...
<dx:PanelContent runat="server" SupportsDisabledAttribute="True">
    ...
    ClientInstanceName="ASPxGridViewExpertTickets" 
    CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
    KeyFieldName="TT_Id;Source" AutoGenerateColumns="False" Width="100%" 
    ClientIDMode="AutoID" ID="ASPxGridViewExpertTickets" 
    EnableViewState="False" 
        Theme="Metropolis" style="font-size: 8pt;" 
        OnHtmlRowPrepared="ASPxGridViewExpertTickets_HtmlRowPrepared" 
        OnRowUpdating="ASPxGridViewExpertTickets_RowUpdating" 
        OnLoad="ASPxGridViewExpertTickets_Load" 
                    OnHtmlDataCellPrepared="ASPxGridViewExpertTickets_HtmlDataCellPrepared" 
                    OnStartRowEditing="ASPxGridViewExpertTickets_StartRowEditing">
<ClientSideEvents Init="function(s, e) {
	window.pagegrid = s;
}"></ClientSideEvents>
<Columns>
    <dx:GridViewCommandColumn ButtonType="Image" ShowInCustomizationForm="True" VisibleIndex="0" Width="60px" Name="CommandButtons" Caption=" " ShowEditButton="True" ShowCancelButton="True" ShowUpdateButton="True"/>
...
<ProgressBar Height="25px"></ProgressBar>
                    ...
                    <Templates>
                        <EditForm>
                            <table class="dxflInternalEditorTable_Aqua" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="style8" colspan="4" 
                                        
                                        style="border: 1px solid #C0C0C0; padding: 0px; background-color: #0099CC;">
                                        Expert section</td>
                                </tr>
                                <tr>
                                    <td class="style2" style="text-align: right; padding-top: 4px;" width="140">
                                        <dx:ASPxLabel ID="ASPxLabelResources" runat="server" style="font-size: 8pt" 
                                            Text="Expertise &amp; resources:">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td align="right" width="180" style="padding-top: 4px;">
                                        <dx:ASPxCheckBox ID="Climber" runat="server" CheckState="Unchecked" 
                                            Font-Size="8pt" Theme="Metropolis" Value='<%# Bind("Climber") %>' 
                                            oninit="Climber_Init" Text="Climber" TextAlign="Left">
                                        </dx:ASPxCheckBox>
                                    </td>
                                    <td class="style4" 
                                        style="text-align: right; padding-top: 4px; padding-right: 3px;" width="120">
                                        <dx:ASPxLabel ID="ASPxLabelComment" runat="server" style="font-size: 8pt" 
                                            Text="Expert Comment:">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td rowspan="5" valign="top" style="padding-top: 4px; padding-bottom: 4px;">
                                        <dx:ASPxMemo ID="Comment" runat="server" Font-Size="8pt" Height="110px" 
                                            oninit="Comment_Init" Text='<%# Bind("Comment") %>' Width="100%">
                                        </dx:ASPxMemo>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        &nbsp;</td>
                                    <td align="right">
                                        <dx:ASPxCheckBox ID="Electrician" runat="server" CheckState="Unchecked" 
                                            Font-Size="8pt" Theme="Metropolis" Value='<%# Bind("Electrician") %>' 
                                            oninit="Electrician_Init" Text="Electrician" TextAlign="Left">
                                        </dx:ASPxCheckBox>
                                    </td>
                                    <td>
                                        &nbsp;</td>
                                ...
                                <tr>
                                    <td>
                                        &nbsp;</td>
                                    <td align="right">
                                        <dx:ASPxCheckBox ID="AirCondition" runat="server" CheckState="Unchecked" 
                                            Font-Size="8pt" Theme="Metropolis" Value='<%# Bind("AirCondition") %>' 
                                            oninit="AirCondition_Init" Text="Air Condition engineer" TextAlign="Left">
                                        </dx:ASPxCheckBox>
                                    </td>
                                    <td>
                                        &nbsp;</td>
                                ...
                                <tr>
                                    <td>
                                        &nbsp;</td>
                                    <td align="right">
                                        <dx:ASPxCheckBox ID="SpareParts" runat="server" CheckState="Unchecked" 
                                            Font-Size="8pt" oninit="SpareParts_Init" Text="Spare Parts" TextAlign="Left" 
                                            Theme="Metropolis" Value='<%# Bind("SpareParts") %>'>
                                        </dx:ASPxCheckBox>
                                    </td>
                                    <td>
                                        &nbsp;</td>
                                ...
                                <tr>
                                    <td>
                                        &nbsp;</td>
                                    <td align="right">
                                        <dx:ASPxCheckBox ID="Instruments" runat="server" CheckState="Unchecked" 
                                            Font-Size="8pt" oninit="Instruments_Init" Text="Instruments" TextAlign="Left" 
                                            Theme="Metropolis" Value='<%# Bind("Instruments") %>'>
                                        </dx:ASPxCheckBox>
                                    </td>
                                    <td>
                                        &nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        &nbsp;</td>
                                    <td style="text-align: right; padding-top: 8px; padding-right: 3px;" 
                                        valign="top">
                                        <dx:ASPxLabel ID="ASPxLabelCommentRegionResp" runat="server" 
                                            style="font-size: 8pt; color: #FF6666" Text="Region Resp Comment:">
                                        </dx:ASPxLabel>
                                    </td>
                                    <td valign="top" style="padding-top: 4px;">
                                        <dx:ASPxMemo ID="CommentRegionResp" runat="server" Font-Size="8pt" 
                                            Height="110px" oninit="CommentRegionResp_Init" 
                                            Text='<%# Bind("Region_Resp_Comment") %>' Width="100%">
                                        </dx:ASPxMemo>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 2px;">
                                        <dx:ASPxGridViewTemplateReplacement ID="Edit_btn" runat="server" 
                                            ReplacementType="EditFormUpdateButton" />
                                        <dx:ASPxGridViewTemplateReplacement ID="Cancel_btn" runat="server" 
    ...
    <dx:ASPxGridViewExporter ID="ASPxGridViewExporter2" runat="server" 
        GridViewID="ASPxGridViewExpertTickets" Landscape="True" PaperKind="A4">
        <Styles>
