<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActiveSchedules.aspx.cs" Inherits="TTWeb.ActiveSchedules" %>
        ...
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" ClientIDMode="AutoID" 
            ...
            <Paddings PaddingBottom="6px" PaddingLeft="9px" 
                ...
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">Active Schedules
...
<dx:PanelContent runat="server" SupportsDisabledAttribute="True">
    <dx:ASPxGridView ID="ASPxGridViewAllSCHs" runat="server" 
        ...
        OnDetailRowExpandedChanged="ASPxGridViewAllSCHs_DetailRowExpandedChanged" ClientInstanceName="ActiveSCHsGrid" 
