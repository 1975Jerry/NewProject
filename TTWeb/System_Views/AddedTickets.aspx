<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddedTickets.aspx.cs" Inherits="TTWeb.AddedTickets" %>
...
<body style="font-size: 8pt">
    ...
    function OnGetSelectedFieldValues(selectedValues) {
        for (var i = 0; i < 36; i++) {
            var editor = ASPxGridViewAddedTickets.GetEditor(i + 1);
            if (editor != null) {
    ...
    <div>
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" ClientIDMode="AutoID" 
            ...
            GroupBoxCaptionOffsetY="-19px" HeaderText="Added Tickets" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">Added VF Trouble Tickets
                        </td>
...
<table cellpadding="0" cellspacing="0" class="style1">
    ...
    ClientInstanceName="ASPxGridViewAddedTickets" 
    CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
    KeyFieldName="TT_Id" AutoGenerateColumns="False" Width="100%" 
    ClientIDMode="AutoID" ID="ASPxGridViewAddedTickets" 
    EnableViewState="False" 
        Theme="Metropolis" style="font-size: 8pt" 
        OnHtmlDataCellPrepared="ASPxGridViewAddedTickets_HtmlDataCellPrepared" 
        OnRowInserting="ASPxGridViewAddedTickets_RowInserting" 
        OnRowUpdating="ASPxGridViewAddedTickets_RowUpdating" 
        OnRowDeleting="ASPxGridViewAddedTickets_RowDeleting" 
        OnHtmlRowCreated="ASPxGridViewAddedTickets_HtmlRowCreated">
...
<ProgressBar Height="25px"></ProgressBar>
    ...
    s.SetSelectedIndex(-1);
                                            ...
                                            <Items>
                                                <dx:ListEditItem Text="ASSIGNED (VENDOR)" Value="ASSIGNED (VENDOR)" />
                                                <dx:ListEditItem Text="ASSIGNED (VF)" Value="ASSIGNED (VF)" />
    ...
    s.SetSelectedIndex(-1);
                                ...
                                <tr>
                                    <td bgcolor="#FFF4F2" class="style3">
                                        <span class="style12">* </span>Send to vendor on:</td>
                                    <td bgcolor="#FFF4F2">
    ...
    s.SetSelectedIndex(-1);	
                                    ...
                                    <td class="dxmBrdCor" rowspan="2" 
                                        style="border-width: 1px; border-color: #C0C0C0; border-left-style: solid">
                                        <span class="style12">** Attention: when Uploading tickets, the specific ticket 
    ...
    <dx:ASPxGridViewExporter ID="ASPxGridViewExporter2" runat="server" 
        GridViewID="ASPxGridViewAddedTickets" Landscape="True" 
        MaxColumnWidth="500" PaperKind="A4">
        <Styles>
            <Default Font-Size="8pt">
            </Default>
        </Styles>
        <PageHeader Left="Added Tickets" Right="[Page # of Pages #]">
        </PageHeader>
