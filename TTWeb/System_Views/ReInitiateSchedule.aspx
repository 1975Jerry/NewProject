<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReInitiateSchedule.aspx.cs" Inherits="TTWeb.ReInitiateSchedule" %>
...
<body>
    ...
    <div style="background-color: #F4F4F4">
        ...
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" 
            HeaderText="Re-Initiate Schedule" Height="256px" Theme="Metropolis" 
            Width="100%">
    ...
    <table cellpadding="0" cellspacing="0" class="style34" 
        ...
        <tr>
            <td style="padding-right: 0px; border-right-width: 0px; margin-right: 0px;" 
                width="100%">
                <dx:ASPxMenu ID="ASPxMenuReInitiate" runat="server" Font-Bold="True" 
...
if((ASPxClientEdit.ValidateEditorsInContainer(null) == true) &amp;&amp; (ScheduleProblemsGrid.cpRowCount != 0))
{
		...
		ClientPopupControlReInitiate.ShowAtElement(element);
}                                        
else
{
   		...
   		alert('Please, check required fields and add at least one ticket.');
                    ...
                    <Items>
                        <dx:MenuItem Name="ReInitiateSchedule" Text="Re-Initiate Schedule">
	...
	window.history.back();
        ...
        <tr>
            <td style="padding-right: 0px; border-right-width: 0px; margin-right: 0px;" 
                width="100%">
                <dx:ASPxPopupControl ID="ASPxPopupControlReInitiate" runat="server" 
                    AllowDragging="True" AllowResize="True" 
                    ClientInstanceName="ClientPopupControlReInitiate" CssClass="style20" 
                    EnableTheming="True" HeaderText="Please choose recipient" 
                    OnWindowCallback="ASPxPopupControlReInitiate_WindowCallback" 
...
if((ASPxClientEdit.ValidateEditorsInContainer(null) == true) &amp;&amp; (ScheduleProblemsGrid.cpRowCount != 0))
{
	...
	{
  	callbackReInitiate.PerformCallback(ToTeam.GetSelectedItem().value);
	}
}                                        
else
{
                    ...
                    <ContentCollection>
                        <dx:PopupControlContentControl runat="server" SupportsDisabledAttribute="True">
                            <dx:ASPxRadioButtonList ID="ASPxRadioButtonListToTeam" runat="server" 
                                ...
                                RepeatColumns="3" TextField="To_Team" Theme="Office2010Silver" 
        ...
        <tr>
            ...
            <td style="border-bottom-style: solid; border-right-style: none; border-right-width: 1px; border-bottom-width: 1px; border-right-color: #CCCCCC; border-bottom-color: #CCCCCC; padding-top: 10px; padding-bottom: 4px;" 
                ...
                <dx:ASPxComboBox ID="ASPxComboBoxToTeam" runat="server" ClientIDMode="AutoID" 
                    ...
                    EnableTheming="True" ShowShadow="False" 
...
<SettingsLoadingPanel ImagePosition="Top"></SettingsLoadingPanel>
            ...
            <td style="border-bottom-style: solid; border-right-style: none; border-right-width: 1px; border-bottom-width: 1px; border-right-color: #CCCCCC; border-bottom-color: #CCCCCC; padding-top: 10px; padding-bottom: 4px;" 
                ...
                <dx:ASPxComboBox ID="ASPxComboBoxToEngineer" runat="server" 
                    ...
                    CssFilePath="~/App_Themes/Aqua/{0}/styles.css" CssPostfix="Aqua" 
                    EnableCallbackMode="True" EnableClientSideAPI="True" 
                    OnCallback="ASPxComboBoxToEngineer_Callback" 
...
<SettingsLoadingPanel ImagePosition="Top"></SettingsLoadingPanel>
            ...
            <td style="border-right: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC; padding-top: 10px; padding-bottom: 4px; text-align: left;">
                <dx:ASPxComboBox ID="ASPxComboBoxToEngineer2" runat="server" 
                    ...
                    CssFilePath="~/App_Themes/Aqua/{0}/styles.css" CssPostfix="Aqua" 
                    EnableCallbackMode="True" EnableClientSideAPI="True" 
                    OnCallback="ASPxComboBoxToEngineer2_Callback" 
                    ShowShadow="False" SpriteCssFilePath="~/App_Themes/Aqua/{0}/sprite.css" 
                    Theme="PlasticBlue" Width="200px">
                    <ClientSideEvents EndCallback="function(s, e) {
...
ticketsgrid.Refresh();
        ...
        <tr>
            <td colspan="4" >
                <dx:ASPxGridView ID="ASPxGridViewAttachments" runat="server" align="right" 
                    ...
                    CssClass="style20" KeyFieldName="Hidden_attacment_id" 
                    OnCustomJSProperties="ASPxGridViewAttachments_CustomJSProperties" 
                    OnRowDeleting="ASPxGridViewAttachments_RowDeleting" Width="260px" ClientVisible="False">
                    <Columns>
    ...
    <dx:ASPxCallback ID="ASPxCallbackReInitiate" runat="server" 
        ClientInstanceName="callbackReInitiate" 
        OnCallback="ASPxCallbackReInitiate_Callback">
    </dx:ASPxCallback>
    <br class="style20" />
                </dx:PanelContent>
</PanelCollection>
