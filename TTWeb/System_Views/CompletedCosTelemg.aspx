<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompletedCosTelemg.aspx.cs" Inherits="TTWeb.CompletedCosTelemg" %>
...
<body style="font-size: 8pt">
    ...
    function OnGetSelectedFieldValues(selectedValues) {
        for (var i = 0; i < 36; i++) {
            var editor = ASPxGridViewCompletedCosTelemg.GetEditor(i + 1);
            if (editor != null) {
    ...
    <div>
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" ClientIDMode="AutoID" 
            ...
            GroupBoxCaptionOffsetY="-19px" HeaderText="Completed CosTelemg" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">Completed Cosmote Telemg Installation Tickets
                        </td>
...
<dx:PanelContent runat="server" SupportsDisabledAttribute="True">
    ...
    ClientInstanceName="ASPxGridViewCompletedCosTelemg" 
    CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
    KeyFieldName="COS_TELEMG_ID" AutoGenerateColumns="False" Width="100%" 
    ClientIDMode="AutoID" ID="ASPxGridViewCompletedCosTelemg" 
    EnableViewState="False" 
        Theme="Metropolis" style="font-size: 8pt" 
        OnHtmlRowPrepared="ASPxGridViewCompletedCosTelemg_HtmlRowPrepared">
...
<ProgressBar Height="25px"></ProgressBar>
    ...
    <dx:ASPxGridViewExporter ID="ASPxGridViewExporter2" runat="server" 
        GridViewID="ASPxGridViewCompletedCosTelemg" Landscape="True" PaperKind="A4">
        <Styles>
            <Default Font-Size="8pt">
            </Default>
        </Styles>
        <PageHeader Left="Completed Cosmote Telemg Tickets" 
            Right="[Page # of Pages #]">
        </PageHeader>
