<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActiveWindTicketsMap.aspx.cs" Inherits="TTWeb.System_Views.ActiveWindTicketsMap" %>
...
<head id="Head1" runat="server">
    ...
    <script charset="UTF-8" type="text/javascript">
        ...
        function InitMap() {
            ...
            coordinatesCallback.PerformCallback('All;All;All');
        }
...
<body  onload="onLoadSystems()">
    ...
    <form id="form1" runat="server">
        ...
        <table class="style1" style="padding-bottom: 8px">
            <tr>
                <td 
                    style="padding-bottom: 8px;" colspan="6">
                    <span class="style8">Active Wind Trouble Tickets Map</span></td>
            </tr>
            <tr>
                <td class="style7" 
                ...
                <td style="background-color: #FBFBFB;" width="140">
                    <dx:ASPxComboBox ID="ASPxComboBoxPriority" runat="server" EnableTheming="True" 
                        Font-Size="8pt" SelectedIndex="7" Theme="Aqua" Width="120px" 
                        ClientInstanceName="priority">
                        <ClientSideEvents SelectedIndexChanged="function(s, e) {
	coordinatesCallback.PerformCallback(priority.GetText()+';'+period.GetText()+';'+processed.GetText());
}" />
                        <Items>
	...
	coordinatesCallback.PerformCallback(priority.GetText()+';'+period.GetText()+';'+processed.GetText());
                ...
                <td style="background-color: #FBFBFB;">
                    <dx:ASPxComboBox ID="ASPxComboBoxProcessed" runat="server" EnableTheming="True" 
                        Font-Size="8pt" SelectedIndex="0" style="font-size: 8pt" Theme="Aqua" 
                        Width="120px" ClientInstanceName="processed">
                        <ClientSideEvents SelectedIndexChanged="function(s, e) {
	coordinatesCallback.PerformCallback(priority.GetText()+';'+period.GetText()+';'+processed.GetText());
}" />
                        <Items>
