<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CancelledSchedules.aspx.cs" Inherits="TTWeb.CancelledSchedules" %>
...
<body>
    ...
    <div>
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" ClientIDMode="AutoID" 
            ...
            GroupBoxCaptionOffsetY="-19px" HeaderText="All Cancelled SCHs" 
            ...
            <Paddings PaddingLeft="9px" 
                ...
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">Cancelled Schedules</td>
...
<dx:PanelContent runat="server" SupportsDisabledAttribute="True">
    <dx:ASPxGridView ID="ASPxGridViewAllSCHs" runat="server" 
        ...
        OnDetailRowExpandedChanged="ASPxGridViewAllSCHs_DetailRowExpandedChanged" ClientInstanceName="CancelledSCHsGrid" 
	...
	window.pagegrid = s;
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="Cancelled by" FieldName="Cancelled_by" Name="Cancelled_by" 
                ...
                <PropertiesComboBox ShowImageInEditBox="True" ValueField="Status" 
                    ...
                    <Items>
                        ...
                        <dx:ListEditItem ImageUrl="~/Images/SignOff.png" Text=" " 
                            Value="Sign Off" />
                        <dx:ListEditItem ImageUrl="~/Images/Cancelled.png" Text=" " Value="Cancelled" />
                    </Items>
        ...
        <SettingsCookies Enabled="True" Version="19" />
        <SettingsDetail ShowDetailRow="True" AllowOnlyOneMasterRowExpanded="True" />

        <Styles CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" 
            CssPostfix="PlasticBlue">
            <Row BackColor="#FFF9F9">
            </Row>
    ...
    <dx:ASPxGridViewExporter ID="ASPxGridViewExporter2" runat="server" 
        ...
        <PageHeader Right="[Page # of Pages #]" Left="Cancelled Schedules">
        </PageHeader>
