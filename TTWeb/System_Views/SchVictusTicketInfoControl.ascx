<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SchVictusTicketInfoControl.ascx.cs" Inherits="TTWeb.SchVictusTicketInfoControl" %>
...
.dxflInternalEditorTable_Aqua {
    ...
    <div>
        ...
        <dx:ASPxMenu ID="ASPxMenu1" runat="server" BackColor="White" 
            ...
            Theme="Metropolis" Width="100%" Visible="False">
            <Items>
                <dx:MenuItem Name="Export" 
                    NavigateUrl="~/System_Views/SchVictusTicketInfo_Report.aspx" Target="_blank" 
                    Text="Export VictusTicket Info">
        ...
        <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="0" 
            ...
            <TabPages>
                <dx:TabPage Name="VictusTicketInfo" Text="VictusTicket Info">
                    <ContentCollection>
                            ...
                            <table bgcolor="White" class="style1">
                                <tr>
                                    ...
                                    <td style="text-align: right" valign="bottom" width="20%">
                                        <i style="color: #CC3300; text-align: right">VictusTicket ID</i></td>
                                    <td width="50">
                                        &nbsp;</td>
                            ...
                            <dx:ASPxGridView ID="ASPxGridViewLocation" runat="server" 
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataComboBoxColumn Caption="Type" FieldName="Type" 
                                        ...
                                        <PropertiesComboBox>
                                            <Items>
                                                <dx:ListEditItem ImageUrl="~/Images/VictusTicket.png" Text=" " Value="VictusTicket" />
