<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadWindTickets.aspx.cs" Inherits="TTWeb.UploadWindTickets" %>
...
<body>
    ...
    function OnGetSelectedFieldValues(selectedValues) {
        for (var i = 0; i < 36; i++) {
            var editor = ASPxGridViewUploadWindTickets.GetEditor(i + 1);
            if (editor != null) {
    ...
    <div>
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" ClientIDMode="AutoID" 
            ...
            GroupBoxCaptionOffsetY="-19px" HeaderText="Upload Tickets" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="50%" valign="middle" align="left" style="width: 50%">Upload Wind Trouble Tickets </td>
...
<Paddings PaddingTop="10px" PaddingBottom="5px"></Paddings>
    ...
    ClientInstanceName="ASPxGridViewUploadWindTicketsErrors" 
    CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
    KeyFieldName="TT_Id" AutoGenerateColumns="False" Width="100%" 
    ClientIDMode="AutoID" ID="ASPxGridViewUploadWindTicketsErrors" 
...
<dx:GridViewDataTextColumn FieldName="TT_Id" ShowInCustomizationForm="True" 
        Name="TT_Id" Caption="TT Id" VisibleIndex="1"></dx:GridViewDataTextColumn>
<dx:GridViewDataTextColumn FieldName="Status" ShowInCustomizationForm="True" 
        Name="Status" Caption="Status" VisibleIndex="7"></dx:GridViewDataTextColumn>
<dx:GridViewDataTextColumn FieldName="Event_time" 
        ShowInCustomizationForm="True" Name="Event_time" 
        Caption="Event_time" VisibleIndex="8">
</dx:GridViewDataTextColumn>
<dx:GridViewDataTextColumn FieldName="Severity" 
        ShowInCustomizationForm="True" Name="Severity" 
        Caption="Severity" VisibleIndex="9" Visible="False">
</dx:GridViewDataTextColumn>
<dx:GridViewDataTextColumn FieldName="Severity1" 
        ShowInCustomizationForm="True" Name="Severity1" 
        Caption="Severity1" VisibleIndex="10" Visible="False">
</dx:GridViewDataTextColumn>
<dx:GridViewDataTextColumn FieldName="Severity2" 
        ShowInCustomizationForm="True" Name="Severity2" 
        Caption="Severity2" VisibleIndex="11" Visible="False">
</dx:GridViewDataTextColumn>
<dx:GridViewDataTextColumn FieldName="Event_time" ShowInCustomizationForm="True" 
        Name="Event_time" Caption="Event_time" VisibleIndex="12"></dx:GridViewDataTextColumn>
<dx:GridViewDataTextColumn FieldName="BSC" ShowInCustomizationForm="True" 
        Name="BSC" Caption="BSC" VisibleIndex="13"></dx:GridViewDataTextColumn>
<dx:GridViewDataTextColumn FieldName="Object" ShowInCustomizationForm="True" 
        Name="Object" Caption="Object" VisibleIndex="14"></dx:GridViewDataTextColumn>
<dx:GridViewDataTextColumn FieldName="Zone" ShowInCustomizationForm="True" 
        Name="Zone" Caption="Zone" VisibleIndex="15" Visible="False"></dx:GridViewDataTextColumn>
<dx:GridViewDataTextColumn FieldName="Problem" ShowInCustomizationForm="True" 
        Name="Problem" Caption="Problem" VisibleIndex="16"></dx:GridViewDataTextColumn>
<dx:GridViewDataTextColumn FieldName="Comments" 
        ShowInCustomizationForm="True" Name="Comments" 
        Caption="Comments" VisibleIndex="17" Visible="False"></dx:GridViewDataTextColumn>
<dx:GridViewDataTextColumn FieldName="TT_receive_time" ShowInCustomizationForm="True" 
        Name="TT_receive_time" Caption="TT_receive_time" VisibleIndex="18"></dx:GridViewDataTextColumn>
<dx:GridViewDataTextColumn FieldName="Repair_time" ShowInCustomizationForm="True" 
        Name="Repair_time" Caption="Repair_time" VisibleIndex="19"></dx:GridViewDataTextColumn>
</Columns>
...
<PageSizeItemSettings Visible="True"></PageSizeItemSettings>
                    ...
                    <SettingsText EmptyDataRow="Pending uploaded tickets..." />
...
<ProgressBar Height="25px"></ProgressBar>
    ...
    <dx:ASPxCallback ID="ASPxCallback1" runat="server" 
		...
		ASPxGridViewUploadWindTicketsErrors.Refresh();
    ...
    <dx:ASPxPopupControl ID="ASPxPopupControl1" runat="server" 
        ...
        PopupVerticalAlign="WindowCenter" ShowCloseButton="False" Theme="Aqua" 
