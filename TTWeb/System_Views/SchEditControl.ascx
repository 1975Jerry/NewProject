...
if(e.item.name == &quot;Save&quot;) 
{
 ...
 <Items>
     ...
     <dx:MenuItem Name="Export" NavigateUrl="~/SchEdit_Report.aspx" Target="_blank" 
         Text="Export" Enabled="True" Visible="True">
...
if (ToTeam.GetIsValid() &amp;&amp; ToTeam.GetSelectedItem().text == &quot;Dispatcher&quot;)   /* customia */
{
                                                                ...
                                                                <Templates>
                                                                    <DetailRow>
                                                                        <table class="style3">
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="3">
                                                                                    <dx:ASPxGridView ID="ASPxGridViewTickets" runat="server" AutoGenerateColumns="False" EnableTheming="True" Font-Size="8pt" KeyFieldName="Hidden_id" onbeforeperformdataselect="ASPxGridViewTickets_BeforePerformDataSelect" onhtmlrowprepared="ASPxGridViewTickets_HtmlRowPrepared" onload="ASPxGridViewTickets_Load" onrowupdating="ASPxGridViewTickets_RowUpdating" Theme="Aqua" Width="100%">
                                                                                        <Columns>
                                                                                            <dx:GridViewCommandColumn ButtonType="Image" Caption=" " ShowEditButton="True" VisibleIndex="0" Width="60px" />
                                                                                            <dx:GridViewDataTextColumn Caption="ID" FieldName="TT_ID" Name="TT_ID" ReadOnly="True" Visible="False" VisibleIndex="2">
                                                                                                <PropertiesTextEdit>
                                                                                                    <ReadOnlyStyle BackColor="WhiteSmoke">
                                                                                                    </ReadOnlyStyle>
                                                                                                </PropertiesTextEdit>
                                                                                            </dx:GridViewDataTextColumn>
                                                                                            <dx:GridViewDataTextColumn Caption="Issue" FieldName="EVENT" Name="EVENT" ReadOnly="True" VisibleIndex="1" Width="30%">
                                                                                                <PropertiesTextEdit>
                                                                                                    <ReadOnlyStyle BackColor="WhiteSmoke">
                                                                                                    </ReadOnlyStyle>
                                                                                                </PropertiesTextEdit>
                                                                                            ...
                                                                                            <dx:GridViewDataComboBoxColumn Caption="Solved?" FieldName="SOLVED" Name="SOLVED" VisibleIndex="4" Width="15%">
                                                                                                <PropertiesComboBox>
                                                                                                    <Items>
                                                                                                        <dx:ListEditItem Text="Yes" Value="Yes" />
                                                                                                        <dx:ListEditItem Text="No - Site Survey Fault" Value="No - Site Survey Fault" />
                                                                                            ...
                                                                                            <dx:GridViewDataTextColumn Caption="Hidden_id" FieldName="Hidden_id" Name="Hidden_id" Visible="False" VisibleIndex="5">
                                                                                            </dx:GridViewDataTextColumn>
                                                                                            <dx:GridViewDataTextColumn Caption="Expert Info" FieldName="Expert_Comment" Name="Expert_Comment" ReadOnly="True" VisibleIndex="3">
                                                                                                <PropertiesTextEdit>
                                                                                                    <ReadOnlyStyle BackColor="WhiteSmoke">
                                                                                                    </ReadOnlyStyle>
                                                                                                </PropertiesTextEdit>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <dx:ASPxMenu ID="ASPxMenuAddIntervention" runat="server" BackColor="White" EnableTheming="True" Font-Size="8pt" Height="20px" onload="ASPxMenuAddAction_Load" Theme="Metropolis">
                                                                                        <ClientSideEvents ItemClick="function(s, e) {
	                                                                                            ASPxGridViewItemInterventionsCategory.AddNewRow()
                                                                                            }" />
                                                                                        <Items>
                                                                                            <dx:MenuItem Name="AddIntervention" Text="Add Intervention">
                                                                                                <Image Height="10px" Url="~/Images/add.png">
                                                                                                </Image>
                                                                                            </dx:MenuItem>
                                                                                        </Items>
                                                                                ...
                                                                                <td>&nbsp;</td>
                                                                                <td>
                                                                                    <dx:ASPxMenu ID="ASPxMenuAddAction" runat="server" BackColor="White" EnableTheming="True" Font-Size="8pt" onload="ASPxMenuAddAction_Load" Theme="Metropolis">
                                                                                        <ClientSideEvents ItemClick="function(s, e) {
	                                                                                            ASPxGridViewItemActions.AddNewRow()
                                                                                            }" />
                                                                                        <Items>
                                                                                            <dx:MenuItem Name="AddAction" Text="Add Action">
                                                                                                <Image Height="10px" Url="~/Images/add.png">
                                                                                                </Image>
                                                                                            </dx:MenuItem>
                                                                                        </Items>
                                                                                ...
                                                                                <td>
                                                                                    <dx:ASPxGridView ID="ASPxGridViewActions" runat="server" AutoGenerateColumns="False" ClientInstanceName="ASPxGridViewItemActions" EnableTheming="True" Font-Size="8pt" KeyFieldName="Hidden_id" onbeforeperformdataselect="ASPxGridViewActions_BeforePerformDataSelect" oncelleditorinitialize="ASPxGridViewActions_CellEditorInitialize" onhtmlrowprepared="ASPxGridViewActions_HtmlRowPrepared" onload="ASPxGridViewActions_Load" onrowdeleting="ASPxGridViewActions_RowDeleting" onrowinserting="ASPxGridViewActions_RowInserting" onrowupdating="ASPxGridViewActions_RowUpdating" Theme="Aqua" Width="100%">
                                                                                        <Columns>
                                                                                            ...
                                                                                            <dx:GridViewDataCheckColumn Caption="Charge?" FieldName="CHARGEABLE" Name="CHARGEABLE" Visible="False" VisibleIndex="3" Width="50px">
                                                                                            </dx:GridViewDataCheckColumn>
                                                                                        </Columns>
                                                                                        <SettingsBehavior ColumnResizeMode="NextColumn" ConfirmDelete="True" />
                                                                                        <SettingsPager Mode="ShowAllRecords">
 ...
 kilometersread.SetText(gridViewProblems.cpTotalKM + s.GetNumber());
    ...
    costadvance.SetText(String(Math.round((cost-spinadvance.GetValue())*100)/100));
                                                                                            ...
                                                                                            <td class="style84">
                                                                                                <dx:ASPxSpinEdit ID="ASPxSpinToll_credit" runat="server" ClientInstanceName="spintoll_credit" CssClass="Inline" DecimalPlaces="2" DisplayFormatString="N" EnableClientSideAPI="True" Font-Size="8pt" Height="21px" MaxValue="5000" Number="0" style="font-size: 8pt" Theme="Aqua" Width="150px">
                                                                                                    <ClientSideEvents NumberChanged="function(s, e) {
    var credit = CalculateCredit();
    totalcost0.SetText(String(credit));
    totalcostcredit.SetText(String(credit));
                                                                                                ...
                                                                                                <dx:ASPxLabel ID="ASPxLabelToll_credit" runat="server" CssClass="Inline" Font-Size="8pt" style="color: #C0C0C0">
                                                                                                </dx:ASPxLabel>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <dx:ASPxUploadControl ID="ASPxUploadControl1" runat="server" 
                                                                        ...
                                                                        Width="299px">
                                                                        <ValidationSettings AllowedFileExtensions=".jpg, .xls, .jpeg, .bmp, .tif, .tiff, .pdf, .txt, .doc, .gif, .zip" 
                                                                            MaxFileSize="5248000" 
...
<dx:ASPxCallback ID="ASPxCallbackReject" runat="server" 
    ...
    Modal="True" AppearAfter="0" 
                ...
                HeaderText="Please choose:" ShowSizeGrip="True" 
