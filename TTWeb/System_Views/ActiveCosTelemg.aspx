<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActiveCosTelemg.aspx.cs" Inherits="TTWeb.ActiveCosTelemg" %>
...
<body style="font-size: 8pt">
    ...
    function OnGetSelectedFieldValues(selectedValues) {
        for (var i = 0; i < 36; i++) {
            var editor = ASPxGridViewActiveCosTelemg.GetEditor(i + 1);
            if (editor != null) {
    ...
    <div>
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" ClientIDMode="AutoID" 
            ...
            GroupBoxCaptionOffsetY="-19px" HeaderText="Active CosTelemg" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">Active Cosmote Telemg Installation Tickets
                        </td>
...
<table cellpadding="0" cellspacing="0" class="style1">
	...
	{
        popupsri1.Show();
        CallbackSRI.PerformCallback(ASPxGridViewActiveCosTelemg.GetRowKey(ASPxGridViewActiveCosTelemg.GetFocusedRowIndex()));
    }
	...
	{          
		ASPxGridViewActiveCosTelemg.AddNewRow();
                                ...
                                <Items>
                                    ...
                                    <dx:MenuItem Name="AddSuppl" Text="Add Telemg Ticket">
    ...
    ClientInstanceName="ASPxGridViewActiveCosTelemg" 
    CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
    KeyFieldName="COS_TELEMG_ID" AutoGenerateColumns="False" Width="100%" 
    ClientIDMode="AutoID" ID="ASPxGridViewActiveCosTelemg" 
    EnableViewState="False" 
        Theme="Metropolis" style="font-size: 8pt" 
        OnHtmlRowPrepared="ASPxGridViewActiveCosTelemg_HtmlRowPrepared" 
        OnRowInserting="ASPxGridViewActiveCosTelemg_RowInserting" 
        OnRowDeleting="ASPxGridViewActiveCosTelemg_RowDeleting" 
        OnRowUpdating="ASPxGridViewActiveCosTelemg_RowUpdating" 
        OnLoad="ASPxGridViewActiveCosTelemg_Load" 
        OnCellEditorInitialize="ASPxGridViewActiveCosTelemg_CellEditorInitialize1">
...
<dx:GridViewDataTextColumn FieldName="COS_TELEMG_ID" ShowInCustomizationForm="True" 
        Name="COS_TELEMG_ID" Caption="ID" 
    ...
    <dx:GridViewDataComboBoxColumn FieldName="LOT" 
        Name="LOT" ShowInCustomizationForm="True" VisibleIndex="7" 
        Caption="Lot" Width="100px">
...
if (e.result.split(';')[2] == &quot;no&quot;)
{
        ...
        ASPxGridViewActiveCosTelemg.Refresh();
} 
else
{
		popupsri1.Hide();
    ...
    <dx:ASPxGridViewExporter ID="ASPxGridViewExporter2" runat="server" 
        GridViewID="ASPxGridViewActiveCosTelemg" Landscape="True" PaperKind="A4">
        <Styles>
            <Default Font-Size="8pt">
            </Default>
        </Styles>
        <PageHeader Left="Active Cosmote Telemg Tickets" 
            Right="[Page # of Pages #]">
        </PageHeader>
