<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NodesMap.aspx.cs" Inherits="TTWeb.System_Views.ActiveNodesMap" %>
...
<body  onload="onLoadSystems()">
	...
	coordinatesCallback.PerformCallback(period.GetText());
                        ...
                        <Items>
                            ...
                            <dx:ListEditItem Text="Athens" Value="Athens" />
                            <dx:ListEditItem Text="Crete" Value="Crete" />
                            <dx:ListEditItem Text="Ioannina" Value="Ioannina" />
                            <dx:ListEditItem Text="Komotini" Value="Komotini" />
                            <dx:ListEditItem Text="Larissa" Value="Larissa" />
                            <dx:ListEditItem Text="Patra" Value="Patra" />
                            <dx:ListEditItem Text="Thessaloniki" Value="Thessaloniki" />
                            <dx:ListEditItem Text="Tripoli" Value="Tripoli" />
                        </Items>
                    </dx:ASPxComboBox>
                </td>
