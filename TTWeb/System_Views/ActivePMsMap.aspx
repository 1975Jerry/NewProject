<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivePMsMap.aspx.cs" Inherits="TTWeb.System_Views.ActivePMsMap" %>
...
<head id="Head1" runat="server">
    ...
    <script charset="UTF-8" type="text/javascript">
        ...
        function InitMap() {
            ...
            coordinatesCallback.PerformCallback('All;' + year.toString());
        }
...
<body  onload="onLoadSystems()">
    ...
    <form id="form1" runat="server" style="height: 100%">
        ...
        <table class="style1" style="padding-bottom: 8px">
            <tr>
                <td 
                    style="padding-bottom: 8px;" colspan="5">
                    <span class="style8">Active PM Tickets Map</span></td>
            </tr>
            <tr>
                <td class="style7" 
                ...
                <td style="background-color: #FBFBFB;" width="140">
                    <dx:ASPxComboBox ID="ASPxComboBoxPriority" runat="server" EnableTheming="True" 
                        ...
                        ClientInstanceName="priority" onload="ASPxComboBoxPriority_Load">
                        <ClientSideEvents SelectedIndexChanged="function(s, e) {
	coordinatesCallback.PerformCallback(priority.GetText()+';'+period.GetText());
}" />
                        <Items>
                ...
                <td style="background-color: #FBFBFB;" width="140">
                    <dx:ASPxComboBox ID="ASPxComboBoxPeriod" runat="server" EnableTheming="True" 
                        Font-Size="8pt" Theme="Aqua" Width="120px" 
            ...
            <TitlePanel Font-Size="9pt" ForeColor="#336699" HorizontalAlign="Left">
                <Border BorderStyle="None" />
                    ...
                    <dx:SplitterPane AutoHeight="True" Name="Map">
                        <ContentCollection>
<dx:SplitterContentControl runat="server" SupportsDisabledAttribute="True">
    <table class="dxeLyGroup_Metropolis">
        <tr>
            <td>
                <div ID="systemmapdiv" 
...
<ClientSideEvents CallbackComplete="function(s, e) {
    ...
    systemsmap.entities.clear();
        ...
        { 
            ...
            {
                var pin= new  Microsoft.Maps.Pushpin( new Microsoft.Maps.Location(latitude, longitude), {icon: 'bullet-orange-icon.png', width:32, height:32, anchor: new Microsoft.Maps.Point(16, 16)});
