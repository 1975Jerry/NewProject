<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CombinedPMs.aspx.cs" Inherits="TTWeb.CombinedPMs" %>
...
<body style="font-size: 8pt">
    ...
    function OnGetSelectedFieldValues(selectedValues) {
        for (var i = 0; i < 36; i++) {
            var editor = ASPxGridViewCombinedPMs.GetEditor(i + 1);
            if (editor != null) {
    ...
    <div>
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" ClientIDMode="AutoID" 
            ...
            GroupBoxCaptionOffsetY="-19px" HeaderText="Combined PMs" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left" class="style11">Combined VF & Wind PMs
                        </td>
...
<table cellpadding="0" cellspacing="0" class="style1">
	...
	{
        popupsri1.Show();
        CallbackSRI.PerformCallback(ASPxGridViewCombinedPMs.GetRowKey(ASPxGridViewCombinedPMs.GetFocusedRowIndex()));
    }
    ...
    ClientInstanceName="ASPxGridViewCombinedPMs" 
    CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
    KeyFieldName="PM_ID;Source" AutoGenerateColumns="False" Width="100%" 
    ClientIDMode="AutoID" ID="ASPxGridViewCombinedPMs" 
    EnableViewState="False" 
        Theme="Metropolis" style="font-size: 8pt" 
        OnHtmlRowPrepared="ASPxGridViewCombinedPMs_HtmlRowPrepared" 
        OnRowUpdating="ASPxGridViewCombinedPMs_RowUpdating" 
        OnLoad="ASPxGridViewCombinedPMs_Load">
...
<dx:GridViewDataTextColumn FieldName="PM_YEAR" ShowInCustomizationForm="True" 
        Name="PM_YEAR" Caption="Year" VisibleIndex="8" Width="80px" 
        ReadOnly="True">
...
<dx:GridViewDataTextColumn FieldName="PM_TYPE" ShowInCustomizationForm="True" 
        Name="PM_TYPE" Caption="PM Type" VisibleIndex="9" Width="100px" 
        ReadOnly="True">
    <PropertiesTextEdit>
        <ReadOnlyStyle BackColor="#F7F7F7">
        </ReadOnlyStyle>
    ...
    <dx:GridViewDataTextColumn Caption="Name" FieldName="NAME" Name="NAME" 
    ...
    <dx:GridViewDataTextColumn Caption="Node Id" FieldName="Node_ID" Name="Node_ID" 
        ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="4" Width="80px">
        <PropertiesTextEdit>
            <ReadOnlyStyle BackColor="#F7F7F7">
            </ReadOnlyStyle>
        </PropertiesTextEdit>
    ...
    <dx:GridViewDataDateColumn Caption="Completed on" FieldName="VISIT_DATE" 
        ...
        <dx:GridViewDataTextColumn Caption="Info" FieldName="Info" Name="Info" 
        ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="12" Width="120px">
            <PropertiesTextEdit>
                <ReadOnlyStyle BackColor="#F7F7F7">
                </ReadOnlyStyle>
            </PropertiesTextEdit>
    ...
    <dx:GridViewDataTextColumn Caption="Region" FieldName="Region" Name="Region" 
        ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="7" Width="80px">
        <PropertiesTextEdit>
            <ReadOnlyStyle BackColor="#F7F7F7">
            </ReadOnlyStyle>
        </PropertiesTextEdit>
    ...
    <dx:GridViewDataTextColumn Caption="Source" FieldName="Source" 
        Name="Source" ShowInCustomizationForm="True" VisibleIndex="6" 
...
if (e.result.split(';')[2] == &quot;no&quot;)
{
        ...
        ASPxGridViewCombinedPMs.Refresh();
} 
else
{
		popupsri1.Hide();
    ...
    <dx:ASPxGridViewExporter ID="ASPxGridViewExporter2" runat="server" 
        GridViewID="ASPxGridViewCombinedPMs" Landscape="True" 
        MaxColumnWidth="500" PaperKind="A4">
        <Styles>
            <Default Font-Size="8pt">
            </Default>
        </Styles>
        <PageHeader Left="Combined PMs" Right="[Page # of Pages #]">
        </PageHeader>
