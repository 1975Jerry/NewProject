<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VisitsLastMonth.aspx.cs" Inherits="TTWeb.VisitsLastMonth" %>
        ...
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" ClientIDMode="AutoID" 
            ...
            <Paddings PaddingBottom="6px" PaddingLeft="9px" 
                ...
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left" class="style1">Last Month Visits Performed
	...
	window.pagegrid = s;
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="Int. Type" FieldName="Intervention_Type" 
                Name="Intervention_Type" ShowInCustomizationForm="True" VisibleIndex="9" 
                Width="150px">
                <Settings AutoFilterCondition="Contains" />
            </dx:GridViewDataTextColumn>
