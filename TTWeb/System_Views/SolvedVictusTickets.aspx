<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolvedVictusTickets.aspx.cs" Inherits="TTWeb.SolvedVictusTickets" %>
...
<body style="font-size: 8pt">
    ...
    function OnGetSelectedFieldValues(selectedValues) {
        for (var i = 0; i < 36; i++) {
            var editor = ASPxGridViewSolvedVictusTickets.GetEditor(i + 1);
            if (editor != null) {
    ...
    <div>
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" ClientIDMode="AutoID" 
            ...
            GroupBoxCaptionOffsetY="-19px" HeaderText="Solved VictusTickets" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">Solved Victus Trouble Tickets
                        </td>
...
<dx:PanelContent runat="server" SupportsDisabledAttribute="True">
    ...
    ClientInstanceName="ASPxGridViewSolvedVictusTickets" 
    CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
    KeyFieldName="TT_Id" AutoGenerateColumns="False" Width="100%" 
    ClientIDMode="AutoID" ID="ASPxGridViewSolvedVictusTickets" 
    EnableViewState="False" 
        Theme="Metropolis" style="font-size: 8pt" 
        
        OnDetailRowExpandedChanged="ASPxGridViewSolvedVictusTickets_DetailRowExpandedChanged" 
        OnHtmlDataCellPrepared="ASPxGridViewSolvedVictusTickets_HtmlDataCellPrepared" 
                    OnLoad="ASPxGridViewSolvedVictusTickets_Load" 
                    OnRowUpdating="ASPxGridViewSolvedVictusTickets_RowUpdating">
...
<ProgressBar Height="25px"></ProgressBar>
    ...
    <dx:ASPxGridViewExporter ID="ASPxGridViewExporter2" runat="server" 
        GridViewID="ASPxGridViewSolvedVictusTickets" Landscape="True" MaxColumnWidth="500" 
        PaperKind="A4">
        <Styles>
            <Default Font-Size="8pt">
            </Default>
        </Styles>
        <PageHeader Left="Solved VictusTickets" Right="[Page # of Pages #]">
        </PageHeader>
