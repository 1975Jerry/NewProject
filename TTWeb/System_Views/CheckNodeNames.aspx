<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckNodeNames.aspx.cs" Inherits="TTWeb.CheckNodeNames" %>
...
<body style="font-size: 8pt">
    ...
    function OnGetSelectedFieldValues(selectedValues) {
        for (var i = 0; i < 36; i++) {
            var editor = ASPxGridViewCheckNodeNames.GetEditor(i + 1);
            if (editor != null) {
        ...
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" ClientIDMode="AutoID" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">Check source Site Names against Site Lists *
                        </td>
...
<dx:PanelContent runat="server" SupportsDisabledAttribute="True">
    ...
    ClientInstanceName="ASPxGridViewCheckNodeNames" 
    CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
    KeyFieldName="Location;Source" AutoGenerateColumns="False" Width="100%" 
    ClientIDMode="AutoID" ID="ASPxGridViewCheckNodeNames" 
...
<dx:GridViewDataTextColumn FieldName="Num" 
        ShowInCustomizationForm="True" Name="Num" 
        Caption="Number of tickets" VisibleIndex="2" ReadOnly="True">
<PropertiesTextEdit>
...
<dx:GridViewDataTextColumn FieldName="Source" ShowInCustomizationForm="True" 
        Name="Source" Caption="Source" VisibleIndex="3" ToolTip="Freeze_Flag">
    <PropertiesTextEdit>
        <ValidationSettings>
...
<SettingsCookies Enabled="True" Version="27"></SettingsCookies>
...
<SettingsCommandButton>
    ...
    <UpdateButton>
        <Image Height="18px" ToolTip="Save" Url="~/Images/Save.png">
                ...
                <br />
                <span class="style1">* missing sites matching between source ticketing systems 
                and network sites list. Missing sites will not be presented in maps and site 
                name variations will be resolved as multiple visits. </span>
                </dx:PanelContent>
</PanelCollection>
        </dx:ASPxRoundPanel>
    ...
    <dx:ASPxGridViewExporter ID="ASPxGridViewExporter2" runat="server" 
        GridViewID="ASPxGridViewCheckNodeNames" 
        MaxColumnWidth="500" PaperKind="A4">
        <Styles>
            <Default Font-Size="8pt">
            </Default>
        </Styles>
        <PageHeader Left="Check Node Names" Right="[Page # of Pages #]">
        </PageHeader>
