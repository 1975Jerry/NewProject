<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadTickets.aspx.cs" Inherits="TTWeb.UploadTickets" %>
...
<body>
    ...
    function OnGetSelectedFieldValues(selectedValues) {
        for (var i = 0; i < 36; i++) {
            var editor = ASPxGridViewUploadTickets.GetEditor(i + 1);
            if (editor != null) {
        ...
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" ClientIDMode="AutoID" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="50%" valign="middle" align="left" style="width: 50%">Upload VF Trouble Tickets </td>
...
<Paddings PaddingTop="10px" PaddingBottom="5px"></Paddings>
    ...
    ClientInstanceName="ASPxGridViewUploadTicketsErrors" 
    CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
    KeyFieldName="TT_Id" AutoGenerateColumns="False" Width="100%" 
    ClientIDMode="AutoID" ID="ASPxGridViewUploadTicketsErrors" 
...
<dx:GridViewDataTextColumn FieldName="Last_VF_Rejection_Flag" 
        ...
        Caption="Last_VF_Rejection_Flag" VisibleIndex="32" Visible="False"></dx:GridViewDataTextColumn>
...
<ProgressBar Height="25px"></ProgressBar>
    ...
    <dx:ASPxCallback ID="ASPxCallback1" runat="server" 
		...
		ASPxGridViewUploadTicketsErrors.Refresh();
