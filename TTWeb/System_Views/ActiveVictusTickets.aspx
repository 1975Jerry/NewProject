<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActiveVictusTickets.aspx.cs" Inherits="TTWeb.ActiveVictusTickets" %>
...
<%@ Register src="SchVictusTicketInfoControl.ascx" tagname="SchVictusTicketInfoControl" tagprefix="uc1" %>
...
<body style="font-size: 8pt">
    ...
    function OnGetSelectedFieldValues(selectedValues) {
        for (var i = 0; i < 36; i++) {
            var editor = ASPxGridViewActiveVictusTickets.GetEditor(i + 1);
            if (editor != null) {
    ...
    <div>
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" ClientIDMode="AutoID" 
            ...
            GroupBoxCaptionOffsetY="-19px" HeaderText="Active Victus VictusTickets" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">Active Victus Trouble Tickets
                        </td>
...
<table cellpadding="0" cellspacing="0" class="style1">
                    <tr>
                        <td style="padding-right: 0px; border-right-width: 0px; margin-right: 0px; padding-left: 0px;" 
                            ...
                            <dx:ASPxMenu ID="ASPxMenuAttachment" runat="server" ItemAutoWidth="False" Theme="Metropolis" 
                                ...
                                <ClientSideEvents ItemClick="function(s, e) {
	            popupsri1.Show();
                CallbackSRI.PerformCallback(ASPxGridViewActiveVictusTickets.GetRowKey(ASPxGridViewActiveVictusTickets.GetFocusedRowIndex()));
               }
                                    " />
                                <Items>
    ...
    ClientInstanceName="ASPxGridViewActiveVictusTickets" 
    CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
    KeyFieldName="TT_Id" AutoGenerateColumns="False" Width="100%" 
    ClientIDMode="AutoID" ID="ASPxGridViewActiveVictusTickets" 
    EnableViewState="False" 
        Theme="Metropolis" style="font-size: 8pt" 
        
        OnDetailRowExpandedChanged="ASPxGridViewActiveVictusTickets_DetailRowExpandedChanged" 
        OnHtmlDataCellPrepared="ASPxGridViewActiveVictusTickets_HtmlDataCellPrepared" 
        OnLoad="ASPxGridViewActiveVictusTickets_Load" 
        OnRowUpdating="ASPxGridViewActiveVictusTickets_RowUpdating" 
        OnCellEditorInitialize="ASPxGridViewActiveVictusTickets_CellEditorInitialize" 
        OnHtmlRowPrepared="ASPxGridViewActiveVictusTickets_HtmlRowPrepared">
...
<dx:GridViewDataTextColumn FieldName="TT_Id" ShowInCustomizationForm="True" 
    ...
    <dx:GridViewDataDateColumn Caption="Send to Vendor" 
...
<SettingsCookies Enabled="True" Version="98" StoreColumnsVisiblePosition="False"></SettingsCookies>
...
<ProgressBar Height="25px"></ProgressBar>
                    ...
                    <Templates>
                        <DetailRow>
                            <uc1:SchVictusTicketInfoControl ID="SchVictusTicketInfoControl1" runat="server" />
                        </DetailRow>
                    </Templates>
...
if (e.result.split(';')[2] == &quot;no&quot;)
{
        ...
        ASPxGridViewActiveVictusTickets.Refresh();
} 
else
{
		popupsri1.Hide();
    ...
    <dx:ASPxGridViewExporter ID="ASPxGridViewExporter2" runat="server" 
        GridViewID="ASPxGridViewActiveVictusTickets" Landscape="True" 
        MaxColumnWidth="500" PaperKind="A4">
        <Styles>
            <Default Font-Size="8pt">
            </Default>
        </Styles>
        <PageHeader Left="Active VictusTickets" Right="[Page # of Pages #]">
        </PageHeader>
