<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchedulesMap.aspx.cs" Inherits="TTWeb.System_Views.SchedulesMap" %>
...
<head id="Head1" runat="server">
    ...
    <script charset="UTF-8" type="text/javascript">
        ...
        function InitMap() {
            ...
            var dday = day.GetValue();
            var curr_date = dday.getDate();
            var curr_month = dday.getMonth()+1;
            var curr_year = dday.getFullYear();

            coordinatesCallback.PerformCallback(curr_date + "/" + curr_month + "/" + curr_year);
        ...
        <table class="style1" style="padding-bottom: 8px">
            ...
            <tr>
                <td class="style4" 
                    ...
                    width="80">
                    <span class="style5">Schedule day</span>:</td>
                <td style="background-color: #FBFBFB;" width="140">
                    <dx:ASPxDateEdit ID="ASPxDateEditDay" runat="server" ClientInstanceName="day" 
                        EnableTheming="True" Theme="Aqua" oninit="ASPxDateEditDay_Init">
...
<dx:SplitterContentControl runat="server" SupportsDisabledAttribute="True">
    <dx:ASPxGridView ID="ASPxGridViewMissing" runat="server" 
        ...
        <SettingsText Title="Visits not displayed on map:" />
        <Styles>
...
<ClientSideEvents CallbackComplete="function(s, e) {
    ...
    systemsmap.entities.clear();
        ...
        { 
            ...
            {
                var pin= new  Microsoft.Maps.Pushpin( new Microsoft.Maps.Location(latitude, longitude), {icon: 'target.png', width:16, height:16, anchor: new Microsoft.Maps.Point(8, 8)});
