<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompletedPMs.aspx.cs" Inherits="TTWeb.CompletedPMs" %>
...
<body style="font-size: 8pt">
    ...
    function OnGetSelectedFieldValues(selectedValues) {
        for (var i = 0; i < 36; i++) {
            var editor = ASPxGridViewCompletedPMs.GetEditor(i + 1);
            if (editor != null) {
        ...
        <dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" ClientIDMode="AutoID" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">Completed VF PMs
                        </td>
...
<dx:PanelContent runat="server" SupportsDisabledAttribute="True">
    ...
    ClientInstanceName="ASPxGridViewCompletedPMs" 
    CssFilePath="~/App_Themes/PlasticBlue/{0}/styles.css" CssPostfix="PlasticBlue" 
    KeyFieldName="PM_ID" AutoGenerateColumns="False" Width="100%" 
    ClientIDMode="AutoID" ID="ASPxGridViewCompletedPMs" 
    EnableViewState="False" 
        Theme="Metropolis" style="font-size: 8pt" 
        OnHtmlRowPrepared="ASPxGridViewCompletedPMs_HtmlRowPrepared">
...
<dx:GridViewDataTextColumn FieldName="PM_YEAR" ShowInCustomizationForm="True" 
        Name="PM_YEAR" Caption="Year" VisibleIndex="5">
...
<dx:GridViewDataTextColumn FieldName="PM_ID" ShowInCustomizationForm="True" 
    ...
    <dx:GridViewDataComboBoxColumn FieldName="PM_TYPE" 
        Name="PM_TYPE" ShowInCustomizationForm="True" VisibleIndex="6" 
        Caption="PM Type">
        <PropertiesComboBox>
            <Items>
...
<dx:GridViewDataTextColumn FieldName="NAME" ShowInCustomizationForm="True" 
        Name="NAME" Caption="Name" VisibleIndex="3" ToolTip="Response_Freeze">
    <PropertiesTextEdit>
        <ValidationSettings>
            <RequiredField IsRequired="True" />
        </ValidationSettings>
    ...
    <dx:GridViewDataTextColumn Caption="Prefecture" FieldName="NOMOS" 
        Name="NOMOS" ShowInCustomizationForm="True" VisibleIndex="9" 
...
<dx:GridViewDataTextColumn FieldName="Node_ID" ShowInCustomizationForm="True" 
        Name="Node_ID" Caption="Node Id" VisibleIndex="8">
    <PropertiesTextEdit>
        <ValidationSettings>
            <RequiredField IsRequired="True" />
        </ValidationSettings>
    ...
    <dx:GridViewDataDateColumn Caption="Completed on" FieldName="VISIT_DATE" 
        Name="VISIT_DATE" ShowInCustomizationForm="True" VisibleIndex="7">
        ...
        Name="CONTRACT_TYPE" ShowInCustomizationForm="True" VisibleIndex="10" 
        Visible="False">
        <PropertiesComboBox>
            <Items>
    ...
    <dx:GridViewDataTextColumn Caption="Severity" FieldName="CRITICALITY" 
        Name="CRITICALITY" ShowInCustomizationForm="True" VisibleIndex="11">
        <Settings AutoFilterCondition="Contains" />
    </dx:GridViewDataTextColumn>
    ...
    <dx1:GridViewDataTextColumn Caption="Source Id" FieldName="SOURCE_ID" Name="SOURCE_ID" ShowInCustomizationForm="True" VisibleIndex="12">
        <Settings AutoFilterCondition="Contains" />
...
<SettingsCookies Enabled="True" Version="28"></SettingsCookies>
...
<SettingsCommandButton>
    ...
    <dx:ASPxGridViewExporter ID="ASPxGridViewExporter2" runat="server" 
        GridViewID="ASPxGridViewCompletedPMs" Landscape="True" 
        MaxColumnWidth="500" PaperKind="A4">
        <Styles>
            <Default Font-Size="8pt">
            </Default>
        </Styles>
        <PageHeader Left="Completed PMs" Right="[Page # of Pages #]">
        </PageHeader>
