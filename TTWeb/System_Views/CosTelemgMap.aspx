<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CosTelemgMap.aspx.cs" Inherits="TTWeb.System_Views.CosTelemgMap" %>
        ...
        <table class="style1" style="padding-bottom: 8px">
            <tr>
                <td colspan="3" class="style9">
                    Cosmote Active Telemg Installations Map</td>
            </tr>
            <tr>
                <td class="style4" 
...
<ClientSideEvents CallbackComplete="function(s, e) {
    ...
    systemsmap.entities.clear();
        ...
        { 
            ...
            {
                var pin= new  Microsoft.Maps.Pushpin( new Microsoft.Maps.Location(latitude, longitude), {icon: 'bullet-pink-icon.png', width:32, height:32, anchor: new Microsoft.Maps.Point(16, 16)});
