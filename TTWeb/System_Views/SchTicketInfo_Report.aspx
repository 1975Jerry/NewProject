<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchTicketInfo_Report.aspx.cs" Inherits="TTWeb.SchTicketInfo_Report" uiCulture="en" Culture="en-US" %>
...
<body>
    ...
    <div>
        ...
        <dx:ASPxRoundPanel ID="ASPxRoundPanelR" runat="server" ClientIDMode="AutoID" 
            ...
            GroupBoxCaptionOffsetY="-19px" HeaderText="Schedule Report" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">Schedule Report
                        </td>
...
<dx:PanelContent runat="server" SupportsDisabledAttribute="True">
    <table class="style1">
        <tr>
            <td>
                <dx:ReportToolbar ID="SchTicketInfo_ReportToolbar" runat="server" 
                    ClientIDMode="AutoID" ReportViewer="<%# SchTicketInfo_ReportViewer %>" 
                    ShowDefaultButtons="False" Width="650px" BackColor="#F9F9F9" 
                ...
                <dx:ReportViewer ID="SchTicketInfo_ReportViewer" runat="server" ClientIDMode="AutoID" 
