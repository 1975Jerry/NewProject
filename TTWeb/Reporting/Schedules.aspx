<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Schedules.aspx.cs" Inherits="TTWeb.Schedules" uiCulture="en" Culture="en-US" %>
        ...
        <dx:ASPxRoundPanel ID="ASPxRoundPanelR" runat="server" ClientIDMode="AutoID" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">Schedules' Activity Summary Report
                        </td>
