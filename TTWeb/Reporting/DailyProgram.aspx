<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyProgram.aspx.cs" Inherits="TTWeb.DailyProgram" uiCulture="en" Culture="en-US" %>
        ...
        <dx:ASPxRoundPanel ID="ASPxRoundPanelR" runat="server" ClientIDMode="AutoID" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">Daily Program per Engineer Report
                        </td>
        ...
        <tr>
            ...
            <td>
                 <dx:ReportToolbar ID="ReportToolbar1" runat="server" BackColor="#F9F9F9" 
                     ...
                     ShowDefaultButtons="False" Width="670px">
                     <Items>
