<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyVisits.aspx.cs" Inherits="TTWeb.DailyVisits" uiCulture="en" Culture="en-US" %>
        ...
        <dx:ASPxRoundPanel ID="ASPxRoundPanelR" runat="server" ClientIDMode="AutoID" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">Daily Visits Report
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="style3" style="text-align: right; padding-bottom: 10px">
                            <dx:ASPxDateEdit ID="ToDay" runat="server" DisplayFormatString="dd/MM/yyyy" 
                                EditFormat="Custom" EditFormatString="dd/MM/yyyy" EnableTheming="True" 
                                OnInit="ToDay_Init" Theme="SoftOrange" Width="100px">
                            </dx:ASPxDateEdit>
                        </td>
                    </tr>
                    <tr>
