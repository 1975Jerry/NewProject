<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VFTroubleTickets.aspx.cs" Inherits="TTWeb.VFTroubleTickets" uiCulture="en" Culture="en-US" %>
        ...
        <dx:ASPxRoundPanel ID="ASPxRoundPanelR" runat="server" ClientIDMode="AutoID" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">VF Trouble Tickets Summary Report
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="padding-bottom: 5px">
                            <dx:ASPxDateEdit ID="FromDay" runat="server" DisplayFormatString="dd/MM/yyyy" 
                                ...
                                OnInit="FromDay_Init" Theme="SoftOrange" Width="100px">
                            </dx:ASPxDateEdit>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="padding-bottom: 10px">
                            <dx:ASPxDateEdit ID="ToDay" runat="server" DisplayFormatString="dd/MM/yyyy" 
                                EditFormat="Custom" EditFormatString="dd/MM/yyyy" OnInit="ToDay_Init" 
                                Theme="SoftOrange" Width="100px">
                            </dx:ASPxDateEdit>
                        </td>
                    </tr>
                    <tr>
