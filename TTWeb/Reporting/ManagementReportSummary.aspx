<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagementReportSummary.aspx.cs" Inherits="TTWeb.ManagementReportSummary" uiCulture="en" Culture="en-US" %>
                ...
                <table class="dxflInternalEditorTable_SoftOrange">
                    ...
                    <tr>
                        <td class="style3" style="text-align: right; padding-bottom: 10px" colspan="2">
                            <dx:ASPxCheckBoxList ID="Data_Sources" runat="server" Font-Size="8pt" 
                                OnInit="Data_Sources_Init" Theme="Metropolis">
                            </dx:ASPxCheckBoxList>
                        </td>
                    </tr>
                    <tr>
