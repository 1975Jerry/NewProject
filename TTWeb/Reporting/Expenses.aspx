<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Expenses.aspx.cs" Inherits="TTWeb.Expenses" uiCulture="en" Culture="en-US" %>
        ...
        <dx:ASPxRoundPanel ID="ASPxRoundPanelR" runat="server" ClientIDMode="AutoID" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">Expenses Report
                        </td>
                    ...
                    <tr>
                        <td class="style3" style="text-align: right; padding-bottom: 10px" colspan="2">
                            <dx:ASPxComboBox ID="ASPxComboBoxUsers" runat="server" Font-Size="8pt" 
                                OnInit="ASPxComboBoxUsers_Init" style="font-size: 8pt" 
                                Width="130px">
                            </dx:ASPxComboBox>
                        </td>
                    </tr>
