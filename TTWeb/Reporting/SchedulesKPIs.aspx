<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchedulesKPIs.aspx.cs" Inherits="TTWeb.SchedulesKPIs" uiCulture="en" Culture="en-US" %>
        ...
        <dx:ASPxRoundPanel ID="ASPxRoundPanelR" runat="server" ClientIDMode="AutoID" 
            ...
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr>
                        <td width="100%" valign="middle" align="left">Schedules Management KPIs Report
                        </td>
